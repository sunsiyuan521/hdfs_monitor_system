 ...
 * directories, cn.com.psbc.dao.PBImageTextWriter runs two-phase scans:
 *
 * <ol>
 *   <li>The first phase, cn.com.psbc.dao.PBImageTextWriter scans the INode sections to reads the
 ...
 *   <li>The second phase, cn.com.psbc.dao.PBImageTextWriter re-scans the INode sections. For each
    ...
    try (FileInputStream fin = new FileInputStream(file.getFD())) {
      ...
      Collections.sort(sections,
          new Comparator<FileSummary.Section>() {
            @Override
            public int compare(FileSummary.Section s1,
                               FileSummary.Section s2) {
              SectionName n1 =
                  SectionName.fromString(s1.getName());
              SectionName n2 =
                  SectionName.fromString(s2.getName());
              if (n1 == null) {
                return n2 == null ? 0 : -1;
              } else if (n2 == null) {
                return -1;
